...
import com.jiujitsu.api.domain.community.dto.comments.reaction.CommunityCommentReactionRequest;
import com.jiujitsu.api.domain.community.dto.comments.reaction.CommunityCommentReactionResponse;
import com.jiujitsu.api.domain.community.entity.comments.CommunityCommentReactionType;
import com.jiujitsu.api.domain.community.service.CommunityCommentsReactionService;
...
@RestController
@RequestMapping("/api/community/comments/{commentId}")
